...
//  testApp
//
//  Created by 崔关 on 2017/12/21.
//  Copyright © 2017年 juge. All rights reserved.
//

#import <UIKit/UIKit.h>

#ifndef TestAppDefine_h
#define TestAppDefine_h
//字符串是否为空
...
||([_object respondsToSelector:@selector(length)] && [(NSData*)_objectlength] == 0)\
||([_object respondsToSelector:@selector(count)] && [(NSArray*)_objectcount] == 0))
